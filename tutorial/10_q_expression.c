...
void lval_del(lval* v) {
    ...
    switch (v->type) {
        ...
        /* If S-expression or q-expression then delete all elements inside, recusivly of course */
        case LVAL_QEXPR:
        case LVAL_SEXPR:
...
lval* builtin_head(lval* a) {
    ...
    LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
        "Function 'head' passed incorrect datatype!");        
...
lval* builtin_tail(lval* a) {
    ...
    LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
        "Function 'tail' passed incorrect datatype!");        
    LASSERT(a, a->cell[0]->count != 0,
...
lval* builtin_eval(lval* a) {
    LASSERT(a, a->count == 1,
     ...
     LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
        "Function 'eval' passed incorrect datatype!"); 
...
lval* builtin_join(lval* a) {
    for(int i = 0; i < a->count; i++) {
        ...
        "Function 'join' passed incorrect datatype!"); 
    }
    lval* x = lval_pop(a, 0);
    while (a->count) {
